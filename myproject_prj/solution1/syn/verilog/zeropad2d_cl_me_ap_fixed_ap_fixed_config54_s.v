...
module zeropad2d_cl_me_ap_fixed_ap_fixed_config54_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
wire   [3:0] j_fu_121_p2;
reg   [3:0] j_reg_166;
reg    ap_block_state2;
wire   [3:0] i_fu_133_p2;
reg   [3:0] i_reg_174;
reg    ap_block_state10;
wire   [3:0] j_14_fu_145_p2;
reg   [3:0] j_14_reg_182;
reg    ap_block_state18;
wire   [3:0] j_13_fu_157_p2;
reg   [3:0] j_13_reg_190;
...
assign i_fu_133_p2 = (i1_0_reg_82 + 4'd1);

assign icmp_ln112_fu_115_p2 = ((j_0_reg_71 == 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln117_fu_127_p2 = ((i1_0_reg_82 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln121_fu_139_p2 = ((j3_0_reg_93 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln130_fu_151_p2 = ((j6_0_reg_104 == 4'd10) ? 1'b1 : 1'b0);

assign j_13_fu_157_p2 = (j6_0_reg_104 + 4'd1);

assign j_14_fu_145_p2 = (j3_0_reg_93 + 4'd1);

assign j_fu_121_p2 = (j_0_reg_71 + 4'd1);

assign start_out = real_start;

endmodule //zeropad2d_cl_me_ap_fixed_ap_fixed_config54_s
