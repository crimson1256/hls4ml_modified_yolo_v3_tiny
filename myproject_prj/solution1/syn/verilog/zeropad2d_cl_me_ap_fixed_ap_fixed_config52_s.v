...
module zeropad2d_cl_me_ap_fixed_ap_fixed_config52_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
wire   [5:0] j_18_fu_145_p2;
reg   [5:0] j_18_reg_182;
reg    ap_block_state18;
wire   [5:0] j_17_fu_157_p2;
reg   [5:0] j_17_reg_190;
...
assign icmp_ln112_fu_115_p2 = ((j_0_reg_71 == 6'd34) ? 1'b1 : 1'b0);

assign icmp_ln117_fu_127_p2 = ((i1_0_reg_82 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln121_fu_139_p2 = ((j3_0_reg_93 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln130_fu_151_p2 = ((j6_0_reg_104 == 6'd34) ? 1'b1 : 1'b0);

assign j_17_fu_157_p2 = (j6_0_reg_104 + 6'd1);

assign j_18_fu_145_p2 = (j3_0_reg_93 + 6'd1);

assign j_fu_121_p2 = (j_0_reg_71 + 6'd1);

assign start_out = real_start;

endmodule //zeropad2d_cl_me_ap_fixed_ap_fixed_config52_s
