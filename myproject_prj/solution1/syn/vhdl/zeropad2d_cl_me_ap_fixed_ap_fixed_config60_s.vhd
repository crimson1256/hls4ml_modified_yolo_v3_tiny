...
entity zeropad2d_cl_me_ap_fixed_ap_fixed_config60_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of zeropad2d_cl_me_ap_fixed_ap_fixed_config60_s is 
    ...
    signal j_2_fu_145_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal j_2_reg_182 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_block_state18 : BOOLEAN;
    signal j_1_fu_157_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal j_1_reg_190 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    j_1_fu_157_p2 <= std_logic_vector(unsigned(j6_0_reg_104) + unsigned(ap_const_lv4_1));
    j_2_fu_145_p2 <= std_logic_vector(unsigned(j3_0_reg_93) + unsigned(ap_const_lv4_1));
