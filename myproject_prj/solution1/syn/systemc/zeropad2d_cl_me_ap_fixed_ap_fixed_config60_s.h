...
#ifndef _zeropad2d_cl_me_ap_fixed_ap_fixed_config60_s_HH_
#define _zeropad2d_cl_me_ap_fixed_ap_fixed_config60_s_HH_
...
struct zeropad2d_cl_me_ap_fixed_ap_fixed_config60_s : public sc_module {
    ...
    // Module declarations
    zeropad2d_cl_me_ap_fixed_ap_fixed_config60_s(sc_module_name name);
    SC_HAS_PROCESS(zeropad2d_cl_me_ap_fixed_ap_fixed_config60_s);
    ...
    sc_signal< sc_lv<4> > j_2_fu_145_p2;
    sc_signal< sc_lv<4> > j_2_reg_182;
    sc_signal< bool > ap_block_state18;
    sc_signal< sc_lv<4> > j_1_fu_157_p2;
    sc_signal< sc_lv<4> > j_1_reg_190;
    ...
    void thread_j_1_fu_157_p2();
    void thread_j_2_fu_145_p2();
