...
entity myproject_axi_lshr_2304ns_12ns_2304_6_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 2304;  --data bitwidth
      din1_WIDTH : INTEGER := 2304;    --shift control bitwidth
      dout_WIDTH : INTEGER := 2304;  --output bitwidth
...
end entity myproject_axi_lshr_2304ns_12ns_2304_6_1;
architecture rtl of myproject_axi_lshr_2304ns_12ns_2304_6_1 is
