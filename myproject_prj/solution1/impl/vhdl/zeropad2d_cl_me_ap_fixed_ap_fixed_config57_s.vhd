...
architecture behav of zeropad2d_cl_me_ap_fixed_ap_fixed_config57_s is 
    ...
    signal j_8_fu_145_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal j_8_reg_182 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state18 : BOOLEAN;
    signal j_7_fu_157_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal j_7_reg_190 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    j_7_fu_157_p2 <= std_logic_vector(unsigned(j6_0_reg_104) + unsigned(ap_const_lv3_1));
    j_8_fu_145_p2 <= std_logic_vector(unsigned(j3_0_reg_93) + unsigned(ap_const_lv3_1));
