...
entity zeropad2d_cl_me_ap_fixed_ap_fixed_config55_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of zeropad2d_cl_me_ap_fixed_ap_fixed_config55_s is 
    ...
    signal j_fu_121_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal j_reg_166 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state2 : BOOLEAN;
    signal i_fu_133_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_reg_174 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state10 : BOOLEAN;
    signal j_12_fu_145_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal j_12_reg_182 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state18 : BOOLEAN;
    signal j_11_fu_157_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal j_11_reg_190 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state33 : BOOLEAN;
    signal j_0_reg_71 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal i1_0_reg_82 : STD_LOGIC_VECTOR (2 downto 0);
    signal j3_0_reg_93 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state25 : BOOLEAN;
    signal j6_0_reg_104 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    i_fu_133_p2 <= std_logic_vector(unsigned(i1_0_reg_82) + unsigned(ap_const_lv3_1));
    icmp_ln112_fu_115_p2 <= "1" when (j_0_reg_71 = ap_const_lv3_6) else "0";
    icmp_ln117_fu_127_p2 <= "1" when (i1_0_reg_82 = ap_const_lv3_4) else "0";
    icmp_ln121_fu_139_p2 <= "1" when (j3_0_reg_93 = ap_const_lv3_4) else "0";
    icmp_ln130_fu_151_p2 <= "1" when (j6_0_reg_104 = ap_const_lv3_6) else "0";
    ...
    j_11_fu_157_p2 <= std_logic_vector(unsigned(j6_0_reg_104) + unsigned(ap_const_lv3_1));
    j_12_fu_145_p2 <= std_logic_vector(unsigned(j3_0_reg_93) + unsigned(ap_const_lv3_1));
    j_fu_121_p2 <= std_logic_vector(unsigned(j_0_reg_71) + unsigned(ap_const_lv3_1));
