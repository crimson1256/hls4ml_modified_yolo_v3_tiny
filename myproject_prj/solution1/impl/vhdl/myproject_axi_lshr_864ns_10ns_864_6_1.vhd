...
entity myproject_axi_lshr_864ns_10ns_864_6_1 is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 864;  --data bitwidth
      din1_WIDTH : INTEGER := 864;    --shift control bitwidth
      dout_WIDTH : INTEGER := 864;  --output bitwidth
...
end entity myproject_axi_lshr_864ns_10ns_864_6_1;
architecture rtl of myproject_axi_lshr_864ns_10ns_864_6_1 is
