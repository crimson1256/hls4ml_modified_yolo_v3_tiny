...
set ID 14
set hasByteEnable 0
set MemName cnnshift_arr_ap_fixed_ap_fixed_32_16_5_3_0_config2_s_layebkb
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_V_read { I 864 vector } } \
} "
}
